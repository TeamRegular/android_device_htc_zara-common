...
LINEEND=" \\"
COUNT=`wc -l ../zara-common/proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../zara-common/proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
...
LINEEND=" \\"
COUNT=`wc -l ../zara-common/common-proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../zara-common/common-proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
